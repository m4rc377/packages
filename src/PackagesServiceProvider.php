...
class PackagesServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            /*$this->publishes([
                __DIR__.'/../resources/views' => resource_path('views/vendor/packages'),
            ], 'views');*/

            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/packages'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/packages'),
            ], 'lang');*/
